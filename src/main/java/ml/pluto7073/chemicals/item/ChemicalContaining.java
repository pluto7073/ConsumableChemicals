...
public interface ChemicalContaining {
	 ...
	 */
	float getChemicalContent(ResourceLocation id, ItemStack stack, Level level);
	 ...
	 */
	default float getConsumedChemicalContent(ResourceLocation id, ItemStack stack, Level level) {
